...
<p>For Dan Halbert, the road to Tycho began in college&mdash;when Lissa Lenz asked to borrow his computer. Hers had broken down, and unless she could borrow another, she would fail her midterm project. There was no one she dared ask, except Dan.</p>

<p>This put Dan in a dilemma. He had to help her&mdash;but if he lent her his computer, she might read his books. Aside from the fact that you could go to prison for many years for letting someone else read your books, the very idea shocked him at first. Like everyone, he had been taught since elementary school that sharing books was nasty and wrong&mdash;something that only pirates would do.</p>
...
<p>Dan resolved the dilemma by doing something even more unthinkable&mdash;he lent her the computer, and told her his password. This way, if Lissa read his books, Central Licensing would think he was reading them. It was still a crime, but the SPA would not automatically find out about it. They would only find out if Lissa reported him.</p>
...
<p>Students were not usually expelled for this&mdash;not directly. Instead they were banned from the school computer systems, and would inevitably fail all their classes.</p>
...
<p><em>This note has been updated several times since the first publication of the story.</em></p>
...
<p>In 2001 the US began attempting to use the proposed Free Trade Area of the Americas (FTAA) treaty to impose the same rules on all the countries in the Western Hemisphere. The FTAA is one of the so-called free trade treaties, which are actually designed to give business increased power over democratic governments; imposing laws like the DMCA is typical of this spirit. The FTAA was effectively killed by Lula, President of Brazil, who rejected the DMCA requirement and others.</p>

<p>Since then, the US has imposed similar requirements on countries such as Australia and Mexico through bilateral "free trade" agreements, and on countries such as Costa Rica through another treaty, CAFTA. Ecuador's President Correa refused to sign a "free trade" agreement with the US, but I've heard Ecuador had adopted something like the DMCA in 2003.</p>
...
<p>The proponents of this scheme have given it names such as "trusted computing" and "Palladium." We call it <a href="https://www.gnu.org/philosophy/can-you-trust.html">treacherous computing"</a> because the effect is to make your computer obey companies even to the extent of disobeying and defying you. This was implemented in 2007 as part of <a href="http://badvista.org/">Windows Vista</a>; we expect Apple to do something similar. In this scheme, it is the manufacturer that keeps the secret code, but the FBI would have little trouble getting it.</p>
...
<p>When this story was first written, the SPA was threatening small Internet service providers, demanding they permit the SPA to monitor all users. Most ISPs surrendered when threatened, because they cannot afford to fight back in court. One ISP, Community ConneXion in Oakland, California, refused the demand and was actually sued. The SPA later dropped the suit, but obtained the DMCA, which gave them the power they sought.</p>

<p>The SPA, which actually stands for Software Publishers Association, has been replaced in its police-like role by the Business Software Alliance. The BSA is not, today, an official police force; unofficially, it acts like one. Using methods reminiscent of the erstwhile Soviet Union, it invites people to inform on their coworkers and friends. A BSA terror campaign in Argentina in 2001 made slightly veiled threats that people sharing software would be raped.</p>

<p>The university security policies described above are not imaginary. For example, a computer at one Chicago-area university displayed this message upon login:</p>
...
<p>The battle for the right to read is already in progress. The enemy is organized, while we are not, so it is going against us. Here are articles about bad things that have happened since the original publication of this article.</p>
...
<p>If we want to stop the bad news and create some good news, we need to organize and fight. The FSF's <a href="http://defectivebydesign.org/">Defective by Design</a> campaign has made a start &mdash; subscribe to the campaign's mailing list to lend a hand. And <a href="http://www.fsf.org/associate">join the FSF</a> to help fund our work.</p>
...
<p>Copyright &copy; 1996, 2002, 2007, 2009, 2010 Richard Stallman<br>
  This essay was written in 1996 and was published in <cite>Communications of the ACM,</cite> vol.&nbsp;40, n.&nbsp;2, February 1997.</p>
