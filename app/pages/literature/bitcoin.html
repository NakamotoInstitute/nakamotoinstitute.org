...
<img class="img-fluid d-block mx-auto my-4" src="/static/img/bitcoin/transactions.svg" onerror="this.src='/static/img/bitcoin/transactions.png'">
...
<img class="img-fluid d-block mx-auto my-4" src="/static/img/bitcoin/timestamp-server.svg" onerror="this.src='/static/img/bitcoin/timestamp-server.png'">
...
<img class="img-fluid d-block mx-auto my-4" src="/static/img/bitcoin/proof-of-work.svg" onerror="this.src='/static/img/bitcoin/proof-of-work.png'">
...
<img class="img-fluid d-block mx-auto my-4" src="/static/img/bitcoin/reclaiming-disk-space.svg" onerror="this.src='/static/img/bitcoin/reclaiming-disk-space.png'">
...
<img class="img-fluid d-block mx-auto my-4" src="/static/img/bitcoin/simplified-payment-verification.svg" onerror="this.src='/static/img/bitcoin/simplified-payment-verification.png'">
...
<img class="img-fluid d-block mx-auto my-4" src="/static/img/bitcoin/combining-splitting-value.svg" onerror="this.src='/static/img/bitcoin/combining-splitting-value.png'">
...
<img class="img-fluid d-block mx-auto my-4" src="/static/img/bitcoin/privacy.svg" onerror="this.src='/static/img/bitcoin/privacy.png'">
...
<p>The probability of an attacker catching up from a given deficit is analogous to a Gambler's Ruin problem. Suppose a gambler with unlimited credit starts at a deficit and plays potentially an infinite number of trials to try to reach breakeven. We can calculate the probability he ever reaches breakeven, or that an attacker ever catches up with the honest chain, as follows<sup><a href="#fn8" id="ref8">[8]</a></sup>:</p>
...
<ol>
	...
	<li id="fn3">
		<p>S. Haber, W.S. Stornetta, <a href="/literature/time-stamp-digital-document/">"How to time-stamp a digital document,"</a> In <em>Journal of Cryptology</em>, vol 3, no 2, pages 99-111, 1991.&nbsp;<a href="#ref2" title="Jump back to [2-5]">↩</a></p>
	</li>

	<li id="fn4">
		<p>D. Bayer, S. Haber, W.S. Stornetta, <a href="/literature/improving-time-stamping/">"Improving the efficiency and reliability of digital time-stamping,"</a> In <em>Sequences II: Methods in Communication, Security and Computer Science</em>, pages 329-334, 1993.&nbsp;<a href="#ref2" title="Jump back to [2-5]">↩</a></p>
	</li>
	...
	<li id="fn7">
		<p>R.C. Merkle, <a href="/literature/public-key-cryptosystems/">"Protocols for public key cryptosystems,"</a> In <em>Proc. 1980 Symposium on Security and Privacy</em>, IEEE Computer Society, pages 122-133, April 1980.&nbsp;<a href="#ref7" title="Jump back to [7]">↩</a></p>
	</li>

	<li id="fn8">
		<p>W. Feller, <a href="/literature/introduction-probability-theory-vol-i/">"An introduction to probability theory and its applications,"</a> 1957.&nbsp;<a href="#ref8" title="Jump back to [8]">↩</a></p>
	</li>
</ol>

<hr>

<p>PDF available in <a href="/static/docs/bitcoin.pdf">English</a>, <a href="/static/docs/bitcoin-zh-cn.pdf">Chinese (Simplified)</a>, <a href="/static/docs/bitcoin-zh-tw.pdf">Chinese (Traditional)</a>, <a href="/static/docs/bitcoin-he.pdf">Hebrew</a>, <a href="/static/docs/bitcoin-it.pdf">Italian</a>, <a href="/static/docs/bitcoin-jp.pdf">Japanese</a>, <a href="/static/docs/bitcoin-ru.pdf">Russian</a>, <a href="/static/docs/bitcoin-es.pdf">Spanish</a>, and <a href="/static/docs/bitcoin-vn.pdf">Vietnamese</a></p>
