...
<p>The first public clocks, built with great expense and hype, served as such authoritative automata. They were explicitly linked to, and drew on, the relentlessly fair timekeeping of the sun, moon, and stars. It was not long, however, before the listeners to bells learned that mechanical clocks on the vulgar earth, unlike their cosmic counterparts in heaven, could be fudged, reset, or spoofed by the sinful humans who operated them. In one 15<sup>th</sup> century bell tower the expensive mechanical clock broke down. Instead of fixing it, the clock was replaced by two ringers using sandglasses.<sup><a id="ref4-8" href="#fn4">4</a></sup> We’ll have more to say about the integrity—the security and fairness—of public mechanical clocks, and of timekeeping in general, below.</p>

<p>The mechanical clock, and especially its key breakthrough the escapement, are much more important than the sandglass from our point of view. For contemporaries, however, the sandglass was equally or more important. Until the widespread use of small table-top mechanical clocks, the sandglass was the primary means of fair timekeeping. The sandglass was visible to all in a room, and it could only be dramatically and obviously “reset”, it couldn’t be fudged like a mechanical clock.</p>

<p>The accuracy of early mechanical clocks, plus or minus 10-15 minutes per day, was not substantially better than that of late water clocks, and was less accurate than the contemporary sandglass. That mechanical clocks nevertheless spread widely in the fourteenth century may be attributed to (a) its automatic striking feature, which allowed the clock to be struck every hour at lower cost, providing about three times as much granularity with which to schedule events – or six times, where the half-hours were struck, or twelve times where striking quarter hours, (b) the cost of operating a mechanical clock was lower than a water clock, (c) the need, caused by the advent of sandglass reckoning, to augment the sandglass with a longer-term and widely and fairly broadcast equal-hour standard, and (d) the moral authority derived from mimicking the independent, fair movements in the cosmos.</p>

<p>Before the mechanical clock, bell towers used the old system of canonical hours, with some untoward consequences. Because the striking was manual, it was usually done only four times during daylight and once at night. The none (“ninth hour”) was originally rung at roughly (what we now call) 3 p.m. During the Middle Ages it wandered back and forth, finally migrating back through the day until it reached its current spot, noon, in the twelfth century. This may have occurred because lunch (or the breaking of fast on certain holy days) was scheduled for none, but the monks tended to get hungry before then. It may have occurred in the service of laborers who got off work at none instead of sundown, although there weren’t very many of these lucky workers. Any such incentive would operate like a ratchet – errors forward caused hungry stomachs or aching bones and so were corrected; errors backwards tended to be ignored and accumulate. This migration naturally occurred at very different speeds at different localities. Different regions were not fully synchronized until long after clock hours had replaced the canonical hours.</p>

<p>Even with the advent of the mechanical clock, its most fair and secure property was not that it told time more accurately – its accuracy slipped by several minutes per day, and the monks or prelates had to be trusted to not reset it. The secure fairness of the bell tower’s broadcast was the most valuable component of the system. However, the mechanical clock’s improvement in accuracy from up to an hour, to only a few minutes, still greatly increased the ability to coordinate and reduced disputes over, for example, daily work times.</p>

<div class="my-4 text-center">
  <img class="mx-auto img-fluid d-block" src="/static/img/docs/a-measure-of-sacrifice/SandglassOld.jpg" />
</div>

<h2>Sandglasses</h2>

<p>An advancing technology in 13<sup>th</sup> century western Europe very different from mechanics was glass-blowing. The origin of the sandglass is quite obscure, but its accuracy relies on a precise ratio between the neck width and the grain diameter. It thus required extensive trial and error for glass-blowers to arrive at hour glasses for sand, ground marble, eggshell, and other sized grains, and techniques for mass producing these precisely sized works of glass, besides a ready of market of users, which Europe turned out to be.</p>

<p>There are no demonstrated cases of sandglasses before the 14<sup>th</sup> century. Manufacture and use of the sand-glass was widespread in western Europe by the middle of the 14<sup>th</sup> century.<sup><a id="ref10-1" href="#fn10">10</a></sup> In 1339 Ambrosio Lorenzetti painted a fresco in Siena, one of the commercial cities of northern Italy, which shows a sandglass as an allegory for temperance (self-control). Mariners in the Mediterranean were likely using sandglasses to measure time and velocity by 1313. By 1394 French housewives were using recipes to make, along with food, glue, ink, and so on, marble grains for an hour-glass:</p>

<p>"Take the grease which comes from the sawdust of marble when those great tombs of black marble be sawn, then boil it well in wine like a piece of meat and skim it, and then set it out to dry in the sun; and boil, skim and dry nine times; and thus it will be good."</p>

<p>Such a recipe presumably creates grains of a size in a precise ratio to a standard hour-glass neck size, thus producing an accurate time.”<sup><a id="ref10-2" href="#fn10">10</a></sup></p>

<p>The sandglass, not the mechanical clock, became between the 13<sup>th</sup> and 16<sup>th</sup> centuries the main European timekeeper in activities as diverse as public meetings, sermons, and academic lectures. It was also the main navigational and scientific clock during that period.<sup><a id="ref4-9" href="#fn4">4</a>,<a id="ref10-3" href="#fn10">10</a></sup></p>

<h2>A Measure of Sacrifice</h2>

<p>The most important institutional breakthrough that accompanied the clock, the time-rate wage, was based on a largely implicit idea that grew with the invention of the clock – the idea of time as a measure of sacrifice.</p>

<p>Mechanical clocks, bell towers, and sandglasses provided the world’s first fair and fungible measure of sacrifice. So many of the things we sacrifice for are not fungible, but we can arrange our affairs around the measurement of the sacrifice rather than its results. Merchants and workers alike used the new precision of clock time to prove, brag, and complain about their sacrifices.</p>

<p>In a letter from a fourteenth-century Italian merchant to his wife, Francesco di Marco Ganti invokes the new hours tell her of the sacrifices he is making: “tonight, in the twenty-third hour, I was called to the college,” and, “I don’t have any time, it is the twenty-first hour and I have had nothing to eat or drink.”<sup><a id="ref4-10" href="#fn4">4</a></sup> Like many cell phone callers today, he wants to reassure her that he is spending the evening working, not wenching.</p>

<p>A major application of clocks was to schedule meeting times. Being a city official was an expected sacrifice as well as a source of political power. To measure the sacrifice, as well as to coordinate more tightly meeting times, the modern clocks of the fourteenth century came in handy. Some regulations of civic meetings of this period point up that that measuring the sacrifice was important, regardless of the variable output of the meetings. In Nuremburg, the Commission of Five “had to observe the sworn minimum meeting time of four “or” (hours) per day, regardless of whether or not they had a corresponding workload. They were also obliged to supervise their own compliance by means of a sandglass.<sup><a id="ref4-11" href="#fn4">4</a></sup></p>

<h2>Time-Rate Wages</h2>

<p>As commerce grew, more quantities need their value to be measured, leading to more complications and more opportunities for fraud. Measurement disputes become too frequent when measuring too many quantities.</p>

<p>Measuring value is hard. Measuring something that actually indicates value is harder. Measuring something related to value and immune to spoofing is hardest of all.</p>

<p>Most workers in the modern economy earn money based on a time rate—the hour, the day, the week, or the month. In agricultural societies slavery, serfdom, and piece rates were more common than time-rate wages. Time measures input rather than output. Time is the main way we arrange our affairs around the measurement of the sacrifice rather than its results.</p>

<div class="my-4 text-center">
  <img class="mx-auto img-fluid d-block" src="/static/img/docs/a-measure-of-sacrifice/notar_300px.jpg" />
</div>

<p>To create anything of value requires some sacrifice. To successfully contract we must measure value. Since we can’t, absent a perfect exchange market, directly measure the economic value of something, we may be able to estimate it indirectly by measuring something else. This something else anchors the performance – it gives the performer an incentive to optimize the measured value. Which measures are the most appropriate anchors of performance? Starting in Europe by the 13<sup>th</sup> century, that measure was increasingly a measure of the sacrifice needed to create the desired economic value.</p>

<p>This is hardly automatic – labor is not value. A bad artist can spend years doodling, or a worker can dig a hole where nobody wants a hole. Arbitrary amounts of time could be spent on activities that do not have value for anybody except, perhaps, the worker himself. To improve the productivity of the time rate contract required two breakthroughs: the first, creating the conditions under which sacrifice is a better estimate of value than piece rate or other measurement alternatives, and second, the ability to measure, with accuracy and integrity, the sacrifice.</p>

<p>Three of the main alternatives to time-rate wages are eliminating worker choice (i.e., serfdom and slavery), commodity market exchange, and piece rates. When eliminating choice, masters and lords imposed high exit costs, often in the form of severe punishments for escape, shirking, or embezzlement. Serfs were usually required to produce a particular quantity of a good (where the good can be measured, as it often can in agriculture) to be expropriated by the lord or master. Serfs kept for their personal use (not for legal trade) either a percentage or the marginal output, i.e. the output above and beyond what they owed, by custom or coercion, to their lord.</p>

<p>Where quantity was not a good measure of value, close observation and control were kept over the laborer, and the main motivator was harsh punishments for failure. High exit costs also provided the lord with a longer-term relationship, thus over time the serf or slave might develop a strong reputation for trustworthiness with the lord. The undesirability of servitude, from the point of view of the laborer at least, is obvious. Serfs and slaves faced brutal work conditions, floggings, starvation, very short life spans, and the inability to escape no matter how bad conditions got.</p>

<p>Piece rates measure directly some attribute of a good or service that is important to its value – its quantity, weight, volume, or the like—and then fix a price for it. Guild regulations which fixed prices often amounted to creating piece rates. Piece rates seem the ideal alternative for liberating workers, but they suffer for two reasons. First, the outputs of labor depend not only on effort, skills, etc. (things under control of the employee), but things out of control of the employee. The employee wants something like insurance against these vagaries of the work environment. The employer, who has more wealth and knowledge of market conditions, takes on these risks in exchange for profit.</p>

<p>In an unregulated commodity market, buyers can reject or negotiate downwards the price of poor quality goods. Sellers can negotiate upwards or decline to sell. With piece rate contracts, on the other hand, there is a fixed payment for a unit of output. Thus second main drawback to piece rates is that they motivate the worker to put out more quantity at the expense of quality. This can be devastating. The tendency of communist countries to pay piece rates, rather than hourly rates, is one reason that, while the Soviet bloc’s quantity (and thus the most straightforward measurements of economic growth) was able to keep up with the West, quality did not (thus the contrast, for example, between the notoriously ugly and unreliable Trabant of East Germany and the BMWs, Mercedes, Audi and Volkswagens of West Germany).</p>

<p>Thus with the time-rate wage the employee is insured against vagaries of production beyond his control, including selling price fluctuations (in the case of a market exchange), or variation in the price or availability of factors of production (in the case of both market exchange or piece rates). The employer takes on these risks, while at the same time through promotion, raises, demotions, wage cuts or firing retaining incentives for quality employee output.</p>

<div class="my-4 text-center">
  <img class="mx-auto img-fluid d-block" src="/static/img/docs/a-measure-of-sacrifice/munt.jpg" />
</div>

<p>Besides lacking implicit insurance for the employee, another limit to market purchase of each worker’s output is that it can be made prohibitively costly by relationship-specific investments. These investments occur when workers engage in interdependent production—as the workers learn the equipment or adapt to each other. Relationship-specific investments can also occur between firms, for example building a cannon foundry next to an iron mine. These investments, when combine with the inability to write long-term contracts that account for all eventualities, motivate firms to integrate. Dealing with unspecified eventualities then becomes the right of the single owner. This incentive to integrate is opposed by the diseconomies of scale in a bureaucracy, caused by the distribution of knowledge, which market exchange handles much better.<sup><a id="ref13" href="#fn13">13</a></sup> An in-depth discussion of economic tradeoffs that produce observed distributions of firm sizes in a market, i.e. the number of workers involved in an employment relationship instead of selling their wares directly or working for smaller firms, has been discussed by Coase<sup><a id="ref11" href="#fn11">11</a></sup> and Williamson<sup><a id="ref12" href="#fn12">12</a></sup>.</p>

<p>The main alternative to market exchange of output, piece rate, or coerced labor (serfdom or slavery) consists of the employers paying by sacrifice—by some measure of the desirable things the employee foregoes to pursue the employer’s objectives. An hour spent at work is an hour not spent partying, playing with the children, etc. For labor, this “opportunity cost” is most easily denominated in time – a day spent working for the employer is a day not spent doing things the employee would, if not for the pay, desire to do.<sup><a id="ref1-1" href="#fn1">1</a>,<a id="ref9" href="#fn9">9</a></sup></p>

<p>Time doesn’t specify costs such as effort and danger. These have to be taken into account by an employee or his union when evaluating a job offer. Worker choice, through the ability to switch jobs at much lower costs than with serfdom, allows this crucial quality control to occur.</p>

<p>It’s usually hard to specify customer preferences, or quality, in a production contract. It’s easy to specify sacrifice, if we can measure it. Time is immediately observed; quality is eventually observed. With employment via a time-wage, the costly giving up of other opportunities, measured in time, can be directly motivated (via daily or hourly wages), while quality is motivated in a delayed, discontinuous manner (by firing if employers and/or peers judge that quality of the work is too often bad). Third parties, say the guy who owned the shop across the street, could observe the workers arriving and leaving, and tell when they did so by the time. Common synchronization greatly reduced the opportunities for fraud involving that most basic contractual promise, the promise of time.</p>

<p>Once pay for time is in place, the basic incentives are in place – the employee is, verifiably, on the job for a specific portion of the day – so he might as well work. He might as well do the work, both quantity and quality, that the employer requires. With incentives more closely aligned by the calendar and the city bells measuring the opportunity costs of employment, to be compensated by the employer, the employer can focus observations on verifying the specific quantity and qualities desired, and the employee (to gain raises and avoid getting fired) focuses on satisfying them. So with the time-wage contract, perfected by northern and western Europeans in the late Middle Ages, we have two levels of the protocol in this relationship: (1) the employee trades away other opportunities to commit his time to the employer – this time is measured and compensated, (2) the employer is motivated, by (positively) opportunities for promotions and wage rate hikes and (negatively) by the threat of firing, to use that time, otherwise worthless to both employer and employee, to achieve the quantity and/or quality goals desired by the employer.<sup><a id="ref1-2" href="#fn1">1</a></sup></p>

<p>Time-rate employment provides a major productivity improvement over servitude or (usually) piece rates. Time-rate contracts however require a reliable and secure—a fair and independent—source of time. Laborers were, even before the advent of the clock, commonly paid by the day. But how long is a “day”? It couldn’t be just daylight hours; this makes for a longer workday than employer and employer might otherwise agree to, and in northern latitudes it varies quite substantially within a year. With the rather heterogeneous measures of time, employer could cheat the employee out of hours, or vice versa, unless they had a securely independent standard of time.</p>

<h2>A Dispute over Time</h2>

<p>Dorhn-van Rossum<sup><a id="ref4-12" href="#fn4">4</a></sup> describes a remarkable 14<sup>th</sup> century French legal dispute between vineyard owners and workers. This case illustrates several points. First, it shows how many of the practices of serfdom, including regulation by custom or royal edict rather than by negotiation between worker and employer, were carried over from serfdom to wage labor. Both the wage and working time of these workers were regulated. Second, it illustrates the kind of dispute that could arise with the unequal canonical hours that were rung ambiguously and less often than the mechanical hours. Reliance on the canonical ringing had been required when workers tried to negotiate a working day different from sunup until sundown. Third, this case shows why the clock ringers needed to be trusted by both workers and employers. Hours rung falsely in a given day led workers to measure the sun for themselves, using a quadrant or their own shadow against a fixed size object. Hours that moved over the years, like the wandering none, had the effect that by keeping to the same customary start and end bells, the actual amount of work changed.</p>

<p>In 1392, the vineyard owners sought and received a royal ordinance for Auxerre and nearby areas. This new law specified the longer sunup to sundown hours that the burghers desired and set a maximum wage. Soon thereafter workers who refused to follow the new regulations were arrested. Royal delegates came to Auxerre to hear the dispute.</p>

<p>Both parties had problems defining the work day. The laborers argued that the custom of ending the work day at none, rather than at sundown, violated the custom of ending work in the afternoon, which was “so old that nobody could remember it every having been otherwise.” The working day ended earlier because the heavy soil made for intense work. Furthermore, none in Auxerre was now being rung later than in previous years, “between the fourth and fifth hour of the afternoon instead of the third.” If the workers were correct, the shifting of none to noon, completed in most other places by 1300, had not yet occurred in Auxerre, and in fact had moved in the other direction. Dohr-van Rossum continues his description:</p>

<blockquote class="blockquote">
  <p>the workers expressed their objection with the help of the new system of reference, [mechanical] clock time, which had long since become established in Auxerre. The only open question is thus how they knew that in the past None had been rung much earlier.</p>
</blockquote>

<p>The burghers countered that they faced poor yields and high costs, denied that the shorter work day was customary, and lamented that the royal ordinance was not being enforced. They added a very serious charge – that the workers had tried to incite a revolt like the 1372 peasant uprisings and tax revolts in Paris. Dohr-van Rossum adds:</p>

<blockquote class="blockquote">
  <p>The burghers drew a clear picture of purposeful reduction of working time that the workers had pursued. At first they had worked to the end of the ringing of None. Then they had left at the beginning of the ringing. Currently they were ceasing work with the <em>cliquet</em>, the pre-signal to the actual ringing. And when the ringing came late in the judgment of the workers, they decided to end the work freely according to the position of the sun. All told they were now working little more than half a day. The historical argumentation by the burghers has flaws. As shown by the draft of the complaint, they were not at all agreed when the workers did in fact cease working in the afternoon. We hear “two hours”, “two and a half hours”, “three and a half hours”, (sometimes with “approximately” added), and finally “long before sundown”.</p>
</blockquote>

<p>We see here a transition state between serfdom and wage labor – wage laborers regulated as if they were serfs. The negotiating flexibility of these day laborers was greatly reduced by regulating the workday and the <em>maximum</em> wage. Why did the royal bureaucrats pretend they knew as much or more about such matters than the owners and workers? Intervention by parties higher in the feudal hierarchy had often been required to regulate and control the life-long relationships between serf and lord, lest on the one hand the output available to the lords be reduced, or on the other hand the lords become so oppressive that peasant rebellion, despite its futility in most cases, arose. The political and legal forms and customs that regulated serfdom were often carried over to wage labor, especially where the economy of the jurisdiction, as with royal France here, was still dominated by serfdom. As the European economy matured, in fits and starts, over the next few centuries such disputes would increasingly be solved by negotiations between the most knowledgeable and interested parties, the owners and workers themselves, and put in the form of time-rate wage contracts.</p>

<h2>Abstract Events</h2>

<p>In many towns and cities of Medieval Europe, schedules were set by negotiations between guilds. The schedules definitions were crude. Most common was sunup or sundown.</p>

<p>For agriculture, the work day of sunup to sundown worked well. Every major culture working the land worked this long day. The start and end times could be verified with integrity. The day was longest in the summer when the demand for work was greatest. The drawback of this strong focal point is that in most cases it excluded the possibility of many alternatives, especially the ability to negotiate a shorter work day in order to moonlight, work on personal projects, or gain time for leisure or family. It also left open for dispute the length of breaks. So dominant was the sunup to sundown tradition that it was often also applied to urban workers, for whom it is far less in keeping with the work demands of their industries.</p>

<p>Since the canonical hours might be rung only four times per day, a custom schedule required a custom set of bells, along with a fair, audited bell ringer.</p>

<p>Cities turned into a cacophony of bells signifying the starts and ends of various events and work schedules.<sup><a id="ref4-13" href="#fn4">4</a></sup> Public mechanical clocks, and especially their feature for automatically striking each hour, twenty-four hours per day, allowed for a separation of duties between time-keeping and the planning or scheduling of specific events. As a “level of indirection”, as a computer scientist would put it, this allowed for an explosion of diversity in the daily schedule while decreasing the conflict of the bells to simply a matter of accuracy in striking the hour.</p>

<p>Some useful integrity properties of old methods were lost. Sunup, sundown, “the time it takes to walk across town”, etc. were independently and inexpensively verifiable events or periods. Clock time depended on the security of the clock-room and the faithfulness of the clock wardens, the guys with the keys to the clock-room. The clock warden was a fiduciary. The clock wardens of 16<sup>th</sup> century Augsburg, for example, had to swear the following oath: “You will swear a learned oath to God and the saints to faithfully regulate, keep, and maintain the clock of the city day and night, with everything that goes with it, and also to faithfully guard and lock the keys to city hall and the clock, including locking and unlocking, also to be faithful to the city and to warn of harm, all this faithfully and without guile.”</p>

<p>On the other hand, people were already and increasingly relying on bell-ringers to ring specific events. Separation of duties between the timekeeper and scheduler, and the automated striker, combined with a locked clock-room, reduced the opportunity and incentive for bell ringer fraud. Rather than resetting the schedule of a specific event that they were familiar with and responsible for, they would be resetting the time for a wide variety of events, with a resulting variety of consequences, and a variety of incentives for the affected parties to verify the time by independent means. Abstract time allowed different kinds of workers, and even different individuals, more flexibility to set verifiable working hours different from the naturally verifiable times of sunup and sundown.</p>

<h2>Equal Hours</h2>

<p>Since the common simple sandglass measured only equal hours, not canonical hours, it encouraged the use of equal rather than canonical hours in the new public mechanical clocks. The public clock hours were mostly heard in the ringing, not seen in the dial, and a mechanism for ringing the variable hours is devilishly difficult—this also encourage the adoption of equal hours. It is possible, as was done with some early clocks in Europe, and when the mechanical clock was introduced into Japan, to add simple mechanisms and dial marks that allow a mechanical clock to display variable hours – but making a clock automatically ring the variable hours is hard.</p>

<p>The equal hour system operated at two levels. At the public level, a mechanical clock would ring each equal hour. At the personal or decentralized level, the sandglass would both measure time within an hour and provide a check against the still-common instances of public clock unreliability and fraud.</p>

<p>Clock hours, equal and relatively accurate, began to replace the unequal (twelve hours in daylight regardless of the length of day) and heterogeneous canonical hours in contracts, laws, and other institutions, starting before 1330, and had mostly replaced the canonical hours by 1370. The historian Jean Froissart shifted from canonical hours to the new clock hours around 1380.</p>

<h2>The Rise of the Time-Rate Wage and the Decline of Serfdom</h2>

<p>Expensive public clocks spread to many European towns and cities in the 14<sup>th</sup> century. What did the Europeans of the time have to say about their costly new clocks? The city of Caen in 1314 installed a clock with the following inscription: “I give the hours voice/to make the common folk rejoice.” While regimentation has its downsides, getting rid of the stress from disputes over the basic issue of what time it is – Artemesia is angry with Bassanio for being late, Bassanio retorts he was early – seemed to bring a great relief and rejoicing to Europe. A fifteenth century petition for a city clock for Lyons declared, “If such a clock were to be made, more merchants would come to the fairs, the citizens would be very consoled, cheerful and happy and would live a more orderly life, and the town would gain in decoration.” By the 16<sup>th</sup> century, European cities were so well synchronized that Rabelais could state “a city without bells is like a blind man without a stick.” The clock and the bells it chimed synchronized the relations among men.</p>

<p>The productivity of Europe greatly increased over this period. This productivity can be estimated by measuring how it was consumed, including:</p>

<ul>
  <li>Increasing the ecological carrying capacity, and thus the population (except as offset by plagues)</li>
  <li>A vast increase in the quantity, quality, and variety of goods and services beyond basic foods</li>
  <li>Shortening of the work day and work week.</li>
</ul>

<h2>Conclusion</h2>

<p>Clock time is a fungible measure of sacrifice. Of all measurement instruments, the clock is the most valuable because so many of the things we sacrifice to create are not fungible. The massive clock towers of Europe, with their enormous loud and resonant bells, broadcasting time fairly across the town and even the countryside, rather than the last relics of the medieval, were the first building block of the wealthy modern world. The Europeans evolved their institutions and deployed two very different but complementary timekeeping devices, the sandglass and the mechanical clock, to partition the day into frequently rung and equal hours. Europe progressed in a virtuous circle where bells and clocks improved the productivity of relationships; the resulting wealthy institutions in turn funded more advances in timekeeping.</p>

<p>The rise of the cities and the merchant revolution was given a temporary setback by the Black Plague, the very century that the clock was introduced, but thereafter economic growth renewed with unprecedented vigor. The massive change on the farm, the dominant form of industry, in the 14<sup>th</sup> and successive centuries from serfdom and slavery to markets and wage labor, was caused not only by the temporary labor shortages of the Black Plague, but more fundamentally and permanently by the time-rate contract and the new ability to accurately and fairly verify its crucial measurement of sacrifice, time. Time rates also became the most common relationship for the mines, mills, factories, and other industries that rapidly grew after the advent of the clock.</p>

<!-- <p>Level of wealth, mode of production, and moral activism played only secondary roles in the end of serfdom. The primary role was played by advances in contractual relationships. Chief among these were the lowering of transaction costs and the consequent spread of the time-rate wage contract. The lowered costs came both from the enhanced ability to measure time with accuracy and integrity and institutional adaptations to that ability. That productivity gave the relationship a large enough political bloc that it could carve out a legal niche more independent from the customs and laws inherited from the feudal relationship. Furthermore, time-rate wage labor enhanced and in turn was enhanced by other institutional advances of the early modern era in Europe, such as the growth of accounting and the joint-stock corporation.</p> -->

<h2>References</h2>

<ol>
  <li id="fn1">
    <p>    A good discussion of time-wage vs. piece-rate vs. other kinds of
      employment contracts can be found in McMillan,
      <em>Games, Strategies, and Managers</em>, Oxford University Press
      1992.&nbsp;<a href="#ref1-1">↩</a>&nbsp;<a href="#ref1-2">↩</a>
    </p>
  </li>

  <li id="fn2">
    <p>    A secondary source for clocks and their impacts is Crosby,
      <em
  ...
  <li id="fn3">
    <p>    Discussions of the unreliability and insecurity of broadcasting time and
      other information on computer networks can be found in Jalote,
      <em>Fault Tolerance in Distributed Systems</em>, PTR Prentice-Hall 1994.
    </p>
  </li>

  <li id="fn4">
    <p>    My main source for clocks and their impact is Dohrn-van Rossum,
      <em>History of the Hour – Clocks and Modern Temporal Orders, </em>
      University of Chicago Press, 1996.&nbsp;<a href="#ref4-1">↩</a>&nbsp;<a
        href="#ref4-2"
        >↩</a
      >&nbsp;<a href="#ref4-3">↩</a>&nbsp;<a href="#ref4-4">↩</a>&nbsp;<a
        href="#ref4-5"
        >↩</a
      >&nbsp;<a href="#ref4-6">↩</a>&nbsp;<a href="#ref4-7">↩</a>&nbsp;<a
        href="#ref4-8"
        >↩</a
      >&nbsp;<a href="#ref4-9">↩</a>&nbsp;<a href="#ref4-10">↩</a>&nbsp;<a
        href="#ref4-11"
        >↩</a
      >&nbsp;<a href="#ref4-12">↩</a>&nbsp;<a href="#ref4-13">↩</a>
    </p>
  </li>

  <li id="fn5">
    <p>    Another secondary source for clocks and their impacts is Landes,
      <em>Revolution in Time</em>, Belknap Harvard 2000.&nbsp;<a href="#ref5"
        >↩</a
      >
    </p>
  </li>
  ...
  <li id="fn6">
    <p>    The keeping of weights and measures by the Church, and description of the
      ceremony and consequences of excommunication for breach of contract in
      14<sup>th</sup>
      century France from Wroe,
      <em>A Fool and His Money</em>, Hill and Wang 1995.&nbsp;<a href="#ref6-1"
        >↩</a
      >&nbsp;<a href="#ref6-2">↩</a>
    </p>
  </li>
  ...
  <li id="fn7">
    <p>    Lopez and Raymond, trans.
      <em>Medieval Trade in the Mediterranean World – Illustrative Documents</em
      >&nbsp;<a href="#ref7-1">↩</a>&nbsp;<a href="#ref7-2">↩</a>
    </p>
  </li>

  <li id="fn8">
    <p>    Vicente Goyzueta, “Cathedral of Qosco City”
      <a href="http://users.bestweb.net/~goyzueta/qosqo/catedral.htm"
        >http://users.bestweb.net/~goyzueta/qosqo/catedral.htm</a
      >&nbsp;<a href="#ref8">↩</a>
    </p>
  </li>

  <li id="fn9">
    <p>    The original sources for much of the time rate contract discussion is
      Seiler, Eric (1984) “Piece rate vs. Time Rate: The Effect of Incentives on
      Earnings”,
      <em>Review of Economics and Statistics</em>
      66: 363-76 and Ehrenberg, Ronald G., editor (1990) “Do Compensation
      Policies Matter?”, Special Issue of
      <em>Indsturial and Labor Relations Review</em>
      43: 3-S-273-S.&nbsp;<a href="#ref9">↩</a>
    </p>
  </li>

  <li id="fn10">
    <p>    The Hourglass Connection, “A Brief History [of the Hourglass]”,
      <a href="http://www.hourglasses.com/html/body_brief_history.html"
        >http://www.hourglasses.com/html/body_brief_history.html</a
      >&nbsp;<a href="#ref10-1">↩</a>&nbsp;<a href="#ref10-2">↩</a>
    </p>
  </li>
