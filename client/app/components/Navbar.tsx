  ...
  return (
    <>
      <nav className="">
        ...
        <div
          className={clsx("md:hidden", { hidden: !menuOpen })}
          id="mobileMenu"
        >
      ...
      <div className="bg-cardinal px-4 py-2 text-center font-medium text-white">
        <a
          href="https://forms.gle/naSFZLGUVrRR4zad6"
          className="hover:text-white hover:underline"
        >
          Help us give the world a world-class bitcoin education. Take our quick
          survey&nbsp;→
        </a>
      </div>
    </>
